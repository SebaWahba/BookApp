    ...
    final List<Map<String, dynamic>> fakeJsonResponse = [
      {
        'id': '1',
        'name': 'Wattpad',
        'image': 'assets/images/wattpad.png',
        'category': 'Books',
        'rating': 4,
      },
      {
        'id': '2',
        'name': 'Kuromi',
        'image': 'assets/images/kuromi.png',
        'category': 'Stationery',
        'rating': 5,
      },
      {
        'id': '3',
        'name': 'Crane & Co',
        'image': 'assets/images/crane&co.png',
        'category': 'Books',
        'rating': 4,
      },
      {
        'id': '4',
        'name': 'GooDay',
        'image': 'assets/images/GooDay.png',
        'category': 'Poems',
        'rating': 4,
      },
      {
      ...
      },
      {
        'id': '8',
        'name': 'Peloton',
        'image': 'assets/images/peloton.png',
        'category': 'Special for you',
        'rating': 4,
      },
      {

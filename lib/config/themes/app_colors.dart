...
class AppColors {
  ...
  static const grey400 = Color(0xFFB8B8B8);
  static const grey500 = Color(0xFFA6A6A6);
  static const grey600 = Color(0xFF7A7A7A);
  static const grey700 = Color(0xFF454545);
  static const grey800 = Color(0xFF292929);
  static const grey900 = Color(0xFF121212);

  //primary
  static const primary50 = Color(0xFFFAF9FD);
  static const primary100 = Color(0xFFE5DEF8);
  static const primary200 = Color(0xFFCABCEF);
  static const primary300 = Color(0xFFA28CE0);
